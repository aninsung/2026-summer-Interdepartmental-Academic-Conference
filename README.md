...
| **Stage 3 RL Refiner 최종 DSC** | **0.8492** | GT-Free 자율 미세 보정 (최상위 기록 🚀) |
| **최종 경계선 오차 (HD95)** | **4.0410 px** | 극소 경계 오차 도달 |

#### 🎯 종양 크기별(Class-wise) 세부 성능 비교

| 종양 크기 클래스 | 매핑된 Expert 백본 | 슬라이스 수 | 초기 DSC | 최종 DSC | **최종 HD95 오차** |
|:---|:---|:---:|:---:|:---:|:---:|
| **Small (<300px)** | **Attention U-Net (Zoom-Refiner)** | 424 | 0.6980 | **0.7012** | **9.9128 px** |
...
|:---|:---:|:---:|:---:|:---:|:---|
| **Active Tumor (≥50px 유효 종양)** | 392 | 0.7262 | **0.7293** | **9.0401 px** | 유효 크기 소형 종양 (Small의 92.5%) |
| **Micro Fragment (<50px 미세 조각)** | 32 | 0.3531 | **0.3566** | **20.6034 px** | 3D 단면 상하단 극소 파편 |
