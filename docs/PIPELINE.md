...
Monotonic DSC Gate는 GT를 보므로 **오프라인 상한 측정 장치**입니다. 이번 실행에서 2,434장 중 **858장(35.3%)** 이 이 게이트로 Stage 2로 되돌아갔습니다. 즉 PPO는 슬라이스 약 3분의 1에서 DSC를 떨어뜨렸고, 보고된 최종 점수는 그 손실을 GT로 걸러낸 값입니다.
